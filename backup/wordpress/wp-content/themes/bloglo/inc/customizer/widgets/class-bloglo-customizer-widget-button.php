...
if ( ! class_exists( 'Bloglo_Customizer_Widget_Button' ) ) :

	/**
	 * Bloglo Customizer widget class
	 */
	class Bloglo_Customizer_Widget_Button extends Bloglo_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$args['values']['text']       = wp_kses( $args['values']['text'], bloglo_get_allowed_html_tags() );
			...
			$this->name        = __( 'Button', 'bloglo' );
			$this->description = __( 'A button with custom link.', 'bloglo' );
		...
		public function form() {
			...
			<!-- Text -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-text"><?php esc_html_e( 'Text', 'bloglo' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button Text', 'bloglo' ); ?>"/>
			</p>

			<!-- URL -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-url"><?php esc_html_e( 'URL', 'bloglo' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button URL', 'bloglo' ); ?>" />
			</p>

			<!-- Target -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-target"><?php esc_html_e( 'Open link in', 'bloglo' ); ?>:</label>
				<span class="buttonset">
					<input 
						...
						<label 
							...
							<?php esc_html_e( 'Same Tab', 'bloglo' ); ?>
						</label>
					</input>
					<input 
						class="switch-input screen-reader-text" 
			...
			<!-- Class -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-class"><?php esc_html_e( 'Additional class', 'bloglo' ); ?>:</label>
				<input 
					type="text" 
