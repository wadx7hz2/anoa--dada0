...
if ( ! class_exists( 'Bloglo_Customizer_Widget_Socials' ) ) :

	/**
	 * Bloglo Customizer widget class
	 */
	class Bloglo_Customizer_Widget_Socials extends Bloglo_Customizer_Widget_Nav {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Social Links', 'bloglo' );
			$this->description = __( 'Links to your social media profiles.', 'bloglo' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="bloglo-widget-socials-style">
