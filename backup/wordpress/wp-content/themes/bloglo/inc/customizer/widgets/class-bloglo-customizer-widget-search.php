...
if ( ! class_exists( 'Bloglo_Customizer_Widget_Search' ) ) :

	/**
	 * Bloglo Customizer widget class
	 */
	class Bloglo_Customizer_Widget_Search extends Bloglo_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Search', 'bloglo' );
			$this->description = __( 'A search form for your site.', 'bloglo' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="bloglo-widget-search-style">
