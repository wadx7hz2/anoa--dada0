 ...
 */
class Bloglo_Customizer_Control_Gallery extends Bloglo_Customizer_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => __( 'Select Images', 'bloglo' ),
				'change'       => __( 'Modify Gallery', 'bloglo' ),
				'default'      => __( 'Default', 'bloglo' ),
				'remove'       => __( 'Remove', 'bloglo' ),
				'placeholder'  => __( 'No images selected', 'bloglo' ),
				'frame_title'  => __( 'Select Gallery Images', 'bloglo' ),
				'frame_button' => __( 'Choose Images', 'bloglo' ),
			)
		);
	}
