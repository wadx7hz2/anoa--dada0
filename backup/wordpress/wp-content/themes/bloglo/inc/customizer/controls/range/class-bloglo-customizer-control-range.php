...
if ( ! class_exists( 'Bloglo_Customizer_Control_Range' ) ) :
	/**
	 * Bloglo Customizer custom heading control class.
	 */
	class Bloglo_Customizer_Control_Range extends Bloglo_Customizer_Control {
		...
		public function enqueue() {
			parent::enqueue();
			$base_font_size = bloglo()->options->get( 'bloglo_html_base_font_size' );
		...
		protected function content_template() {
			?>
			<div class="bloglo-range-wrapper bloglo-control-wrapper">
				...
				<div class="bloglo-control-wrap" data-unit="{{ data.value['unit'] }}">
