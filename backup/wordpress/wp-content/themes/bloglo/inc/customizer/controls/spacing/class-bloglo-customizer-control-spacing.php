<?php
/**
 * Bloglo Customizer custom spacing control class.
 *
 * @package     Bloglo
...
if ( ! class_exists( 'Bloglo_Customizer_Control_Spacing' ) ) :
	/**
	 * Bloglo Customizer custom select control class.
	 */
	class Bloglo_Customizer_Control_Spacing extends Bloglo_Customizer_Control {
		...
		public function to_json() {
			...
			$this->json['title']   = esc_html__( 'Link values', 'bloglo' );
		...
		protected function content_template() {
			?>
			<div class="bloglo-control-wrapper bloglo-spacing-wrapper<# if ( data.responsive ) { #> bloglo-control-responsive <# } #>">
