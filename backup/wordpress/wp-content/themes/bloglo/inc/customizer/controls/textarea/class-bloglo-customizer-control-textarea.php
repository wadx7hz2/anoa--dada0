<?php
/**
 * Bloglo Customizer custom textarea control class.
 *
 * @package     Bloglo
...
if ( ! class_exists( 'Bloglo_Customizer_Control_Textarea' ) ) :
	/**
	 * Bloglo Customizer custom select control class.
	 */
	class Bloglo_Customizer_Control_Textarea extends Bloglo_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="bloglo-control-wrapper bloglo-textarea-wrapper">
