 ...
 * @access public
 */
class Bloglo_Customizer_Control_Generic_Notice extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'bloglo-generic-notice';
	...
	/**
	 * Bloglo_Hiding_Section constructor.
	 *
	...
	public function enqueue() {
		 Bloglo_Customizer_Plugin_Install_Helper::instance()->enqueue_scripts();
	}
	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}"
				class="bloglo-notice accordion-section control-section control-section-{{ data.type }} cannot-expand">
	...
	public function create_plugin_install_button( $slug, $settings = array() ) {
		return Bloglo_Customizer_Plugin_Install_Helper::instance()->get_button_html( $slug, $settings );
	}
}
