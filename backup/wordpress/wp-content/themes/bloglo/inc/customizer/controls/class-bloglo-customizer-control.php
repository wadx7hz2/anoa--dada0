<?php
/**
 * Bloglo Customizer custom control class. To be extended in other controls.
 *
 * @package     Bloglo
...
if ( ! class_exists( 'Bloglo_Customizer_Control' ) ) :
	/**
	 * Bloglo Customizer custom control class. To be extended in other controls.
	 */
	class Bloglo_Customizer_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			if ( isset( $args['responsive'] ) && true === $args['responsive'] ) {
				$this->responsive = apply_filters(
					'bloglo_customizer_responsive_breakpoints',
					array(
						'desktop' => array(
							'title' => esc_html__( 'Desktop', 'bloglo' ),
							'icon'  => 'dashicons dashicons-desktop',
						),
						'tablet'  => array(
							'title' => esc_html__( 'Tablet', 'bloglo' ),
							'icon'  => 'dashicons dashicons-tablet',
						),
						'mobile'  => array(
							'title' => esc_html__( 'Mobile', 'bloglo' ),
		...
		protected function responsive_devices() {
			?>
			<ul class="bloglo-responsive-switchers">
		...
		public static function template_units() {
			?>
			<script type="text/template" id="tmpl-bloglo-control-unit">

				<# if ( _.isObject( data.unit ) ) { #>

					<div class="bloglo-control-unit">
